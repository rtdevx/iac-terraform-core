  ...
  policy = jsonencode({
    ...
    },
    {
      ...
      Action = [
        ...
        "iam:ListAttachedGroupPolicies", # Required to modify IAM Groups
        "iam:AttachGroupPolicy",         # Required to modify IAM Groups
        "iam:DetachGroupPolicy",         # Required to modify IAM Groups 
        "iam:PutRolePolicy",
...
#arn:aws:iam::390157243794:group/admin
      ...
      Resource = [
        ...
        "arn:aws:iam::${var.aws_account_id}:role/OrganizationAccountAccessRole",         # NOTE: iam:GetRole, iam:ListRolePolicies, iam:ListAttachedRolePolicies
      ]
